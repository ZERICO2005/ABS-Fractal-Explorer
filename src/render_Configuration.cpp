...
/* public */
			...
			do {
				...
				switch (output_precision) {
					...
					case Render_Precision_Float128: {
						...
						output_precision = Render_Precision_Float80x2;
						repeatLoop = true;
						continue;
					}
				}
	...
	/* Change Configuration */
		...
		bool Render_Configurator::suggest_Render_Precision_and_Fastest_Method(
			const Rendering_Precision render_precision
		) {
		...
		bool Render_Configurator::update_Precision(fp64 zoom) {
			...
			__attribute__((unused)) constexpr fp64 zoom_float64x4 = 61.4 - zoom_offset;
