...
# Output
BIN_OUTPUT = ./bin/ABS-Fractal-Explorer_Classic
# Sources
...
# Flags
CFLAGS = -std=c++11 -Wall -Wextra -Wshadow -Wno-format-truncation
#LDFLAGS = -lOpenCL -lmingw32 -lSDL2main -lSDL2 -lglfw3 -lglfw3dll -pthread
LDFLAGS = -lOpenCL -lSDL2main -lSDL2 -pthread -static-libgcc -static-libstdc++
